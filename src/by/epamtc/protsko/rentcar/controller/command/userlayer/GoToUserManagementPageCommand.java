...
public class GoToUserManagementPageCommand implements Command {
    private static final String USER_MANAGEMENT_MAPPING = "WEB-INF/jsp/userManagementPage.jsp";
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher(USER_MANAGEMENT_MAPPING).forward(request, response);
    }
}
