...
public class FinalRentActDTO implements Serializable {
    private static final long serialVersionUID = 692591186673696448L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FinalRentActDTO)) return false;

        FinalRentActDTO that = (FinalRentActDTO) o;
